...
.method public static discard(Lokio/q;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1

    .prologue
    .line 147
    :try_start_0
    invoke-static {p0, p1, p2}, Lokhttp3/internal/Util;->skipAll(Lokio/q;ILjava/util/concurrent/TimeUnit;)Z
    :try_end_0
...
.method public static skipAll(Lokio/q;ILjava/util/concurrent/TimeUnit;)Z
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v4, v8, v9}, Lokio/r;->deadlineNanoTime(J)Lokio/r;
    ...
    invoke-interface {p0, v4, v8, v9}, Lokio/q;->read(Lokio/c;J)J
    ...
    invoke-virtual {v2, v0, v1}, Lokio/r;->deadlineNanoTime(J)Lokio/r;
