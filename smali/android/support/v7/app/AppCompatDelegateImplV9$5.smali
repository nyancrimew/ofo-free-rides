...
.method public run()V
    ...
    invoke-virtual {v0, v1, v2, v7, v7}, Landroid/widget/PopupWindow;->showAtLocation(Landroid/view/View;III)V

    const-string v3, "android/widget/PopupWindow"

    const-string v4, "showAtLocation"

    const-string v5, "(Landroid/view/View;III)V"

    const-string v6, "android/widget/PopupWindow"
    ...
    invoke-static {v0, v1, v2, v7, v7}, Lcom/growingio/android/sdk/agent/VdsAgent;->showAtLocation(Landroid/widget/PopupWindow;Landroid/view/View;III)V
    ...
    invoke-virtual {v1, v8}, Landroid/support/v4/view/ViewPropertyAnimatorCompat;->alpha(F)Landroid/support/v4/view/ViewPropertyAnimatorCompat;
    ...
    invoke-virtual {v0, v8}, Landroid/support/v7/widget/ActionBarContextView;->setAlpha(F)V
